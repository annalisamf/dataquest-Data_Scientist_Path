...
happiness2015.columns = happiness2015.columns.str.replace(r"[()\.]", "").str.upper()
happiness2016.columns = happiness2016.columns.str.replace(r"[()\.]", "").str.upper()
...
combined = pd.merge(left = combined, right = regions, on = 'COUNTRY', how = 'left').drop('REGION_x', axis = 1)
missing = combined.isnull().sum()
